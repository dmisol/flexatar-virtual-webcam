...
//    var request = new Request('https://ya2.flexatar.com/data?what=make_web_flx&userid=android_test_id&s_limit=21&send_to_conf=0&tok='+tok);
    const queryString = window.location.search;
    const urlParams = new URLSearchParams(queryString);


    var request = new Request('https://ya2.flexatar.com/data?what=make_web_flx&userid=android_test_id&s_limit=21&send_to_conf=0&tok='+urlParams.get('tok'));
//    var request = new Request('https://flexatar.com/data?what=make_web_flx&userid=android_test_id&s_limit=21&send_to_conf=0');
