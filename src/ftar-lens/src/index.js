...
function isChromeExtensionContext() {
    try {
        ...
        return false; // In case location access throws (extremely rare)
    }
}
...
//     log(e)
// }
log(faceDetectionAssetUrl, "faceDetectionAssetUrl")

const faceParser = new FaceParser(faceDetectionAssetUrl);
